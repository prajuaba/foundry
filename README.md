...
Expect **531 passing**: 131 compiler, 75 integration, 63 file-IO, 52 core, 49 rules, 34 Kafka, 29 MongoDB, 28 connectors, 26 real-time, 23 API, 21 CLI. Run it this way
