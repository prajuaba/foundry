...
/// <summary>
/// Command to trigger the workflow transition 'Ship the order' from 'Approved' to 'Shipped'.
/// </summary>
...
public partial record ShipOrder : IRequest<Unit>, IWorkflowTransitionRequest
{
    /// <summary>
    ...
    public string TransitionId => "ship";

    /// <inheritdoc />
    public string FromState => "Approved";

    /// <inheritdoc />
    public string ToState => "Shipped";
}
