...
/// <summary>
/// Command to trigger the workflow transition 'Submit for fulfilment' from 'Pending' to 'value-gate'.
/// </summary>
...
public partial record SubmitOrderForFulfilment : IRequest<Unit>, IWorkflowTransitionRequest
{
    /// <summary>
    ...
    /// <inheritdoc />
    public string FromState => "Pending";

    /// <inheritdoc />
    public string ToState => "value-gate";
}
