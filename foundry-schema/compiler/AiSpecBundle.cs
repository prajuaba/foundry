  ...
  "workflows": [
    {
      ...
      "states": [
        ...
        { "name": "Settled", "isInitial": false, "isFinal": true },
        { "name": "Rejected", "isInitial": false, "isFinal": true }
      ],
      "transitions": [
        { "id": "t1", "name": "Submit", "fromState": "Draft", "toState": "Review", "trigger": "SubmitClaimCommand" },
